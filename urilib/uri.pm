...
sub FIRSTKEY {
    my $self = shift;
    $ITERATORS{$self} = ['info', 'scheme', 'host', 'port', 'path', 'params', 'query', 'frag', 'user', 'passwd', 'pool', 'pool_size', 'furi', 'furi_size', 'uri', 'uri_size', 'robots', 'robots_size', ];
...
*URI_INFO_HTTP = *uric::URI_INFO_HTTP;
*URI_INFO_FTP = *uric::URI_INFO_FTP;
*URI_INFO_NEWS = *uric::URI_INFO_NEWS;
*URI_INFO_FILE = *uric::URI_INFO_FILE;
*URI_INFO_ROBOTS = *uric::URI_INFO_ROBOTS;
*URI_INFO_SCHEME_MASK = *uric::URI_INFO_SCHEME_MASK;
